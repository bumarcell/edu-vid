...
>
> We named the pieces today, but we glossed over a lot — how containers are actually configured to run on a node, what the different controllers are for, and how a controller goes from "I noticed something" to "I changed something." Plenty to dig into. We'll go deeper in the next ones.
